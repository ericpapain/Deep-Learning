...
'''
se que dois faire notre algo est de scaner la photos de haut en bas, de droite a gauche afin de rechercher 
les descripteurs decris dans le fichier XML.
...
if key==ord('q'):
    ...
    # cette ligne va me permettre de lire plus de 5 images avant de passser a l'image suivante
    for cpt in range(6):
        ret, frame = cap.read()
cap.release()
